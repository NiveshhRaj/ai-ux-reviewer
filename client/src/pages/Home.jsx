  ...
  const exportPDF = () => {
    ...
    Object.keys(grouped).forEach((category) => {
      ...
      grouped[category].forEach((issue) => {
        pdf.setFontSize(12);
        pdf.text(`• ${issue.title}`, 16, y);
        y += 6;

        pdf.setFontSize(10);
        pdf.text(
          pdf.splitTextToSize(issue.reason, 170),
          18,
          y
        );
        y += 8;
        ...
        pdf.text(
          pdf.splitTextToSize("Proof: " + issue.proof, 170),
          18,
          y
        );
        y += 10;
    ...
    review.suggestions.forEach((s, index) => {
      ...
      pdf.setFontSize(10);
      pdf.text(
        pdf.splitTextToSize("Before: " + s.before, 170),
        16,
        y
      );
      y += 8;
      ...
      pdf.text(
        pdf.splitTextToSize("After: " + s.after, 170),
        16,
        y
      );
      y += 12;
...
function ScoreGauge({ score }) {
  ...
  return (
    <div className="relative w-48 h-48 left-7">
      ...
      <div className="absolute inset-0 top-13 left-13 text-3xl font-bold">
        {score}
      </div>
    </div>
  );
